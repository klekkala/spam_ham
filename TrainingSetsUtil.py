...
def make_training_set(path):
    ...
    for direct in path:
        mails_in_dir = [mail_file for mail_file in listdir(direct) if isfile(join(direct, mail_file))]
        ...
        for mail_name in mails_in_dir:
            ...
            message = get_mail_from_file(direct + mail_name)
        ...
        count_values = sum(training_set.values())
                            
    return training_set, count_values

print ''    
print 'Loading training sets...',
#for i in range(1,6):
 #   path = spam_path % i
 #   spam_training_set = make_training_set(path)

#for i in range(1,6):
 #   path = ham_path % i
  #  ham_training_set = make_training_set(path)
